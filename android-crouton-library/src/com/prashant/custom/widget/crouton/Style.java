...
package com.prashant.custom.widget.crouton;
...
public class Style {
  ...
  public static final int holoRedLight = 0xffaa0000;
  public static final int holoGreenLight = 0xff00aa00;
  public static final int holoBlueLight = 0xff33b5e5;
  public static final int holoOrange = 0xffd54f2f;
  ...
  /** Default style for general information. */
  public static final Style CUSTOM_BY_PRASHANT_ORANGE;
  ...
  static {
    ...
    INFO = new Builder()
      ...
      .build();
    CUSTOM_BY_PRASHANT_ORANGE = new Builder()
      .setBackgroundColorValue(holoOrange)
      .build();
  }
